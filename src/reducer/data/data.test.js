...
import {reducer, ActionType, initialState, Operations} from './data';
import {card as film, films, filmReviews as reviews} from '../../utils/test-data.js';
...
describe(`Operations are working correctly`, () => {
  ...
  it(`Should make the correct API call for /films /promo`, () => {
    const apiMock = new MockAdapter(api);
    const dispatch = jest.fn();
  ...
  it(`Should make the correct API call to /favorite`, () => {
    const apiMock = new MockAdapter(api);
    const dispatch = jest.fn();
