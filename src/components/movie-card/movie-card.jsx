...
import {LIST_FILTERS} from '../../data.js';

import MovieCardReviews from '../movie-card-review/movie-card-reviews.jsx';
...
class MovieCard extends PureComponent {
  ...
  render() {
    const {film, relativeFilms} = this.props;
    const {title, genre, coverBackground, poster, release} = film;
...
MovieCard.propTypes = {
  ...
  relativeFilms: PropTypes.array.isRequired
};
